...
export var DateConvert = {
  ...
  convertSolarToLunar: function (year, month, day) {
    ...
    day = parseInt(day);
    let holiday;
    if ((month == 1) && (day == 1)) holiday = "元旦";
    if ((month == 5) && (day == 1)) holiday = "劳动节";
    if ((month == 6) && (day == 1)) holiday = "儿童节";
    if ((month == 10) && (day == 1)) holiday = "国庆节";
    if ((month == 12) && (day == 24)) holiday = "平安夜";
    ...
    let lunarCalendar = this.nStr1[day - 1]
    let oldHoliday;
    if ((month == 1) && (day == 1)) oldHoliday = "春节";
    if ((month == 1) && (day == 15)) oldHoliday = "元宵节";
    if ((month == 4) && (day == 4)) oldHoliday = "清明节";
    if ((month == 6) && (day == 6)) oldHoliday = "端午节";
    if ((month == 7) && (day == 7)) oldHoliday = "七夕节";
    if ((month == 9) && (day == 15)) oldHoliday = "中秋节";
    return { 'year': lunarYear, 'month': month, 'day': day, 'leapMonth': leapMonth, 'lunarCalendar': lunarCalendar, "holiday": holiday,"oldHoliday":oldHoliday};
  },
